...
// Create query
$query = "SELECT DISTINCT r.role
              FROM user AS u
              INNER JOIN role_assignment AS ra ON u.user_id = ra.user_user_id
              INNER JOIN role AS r ON ra.role_role_id = r.role_id
              ORDER BY r.role ASC";
// Run query
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <form id="roleSelectForm" class="form-group">
                        <select id="roleSelect" class="selectpicker form-control" data-live-search="true" name="role" onchange="filterData()">
            ...
            <?php
            if ($roles === false) {
                echo '<div class="alert alert-info" role="alert"><b>NB!</b> No roles are defined yet.</div>';
            }
            ?>

            <div id="usersTableArea" class="table-responsive">
...
<script src="js/users_list.js" charset="utf-8"></script>
