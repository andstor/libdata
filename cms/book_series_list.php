    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Book series
                    <small> - list of book series</small>
                </h1>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <button class="btn btn-success" type="button" name="button"
                            onclick="location.href='add_book_series.php'">
...
<script src="js/book_series_list.js" charset="utf-8"></script>
