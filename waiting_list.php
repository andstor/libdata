...
$query = "SELECT lb.name
          ...
          GROUP BY lb.library_branch_id";
// Run query

$libraryBranches = $db->select($query);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<main role="main">
    <section class="jumbotron m-0 ">
        <div class="container">
            <form action="includes/add_to_waiting_list.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="isbn" value="<?php echo $isbn; ?>">
            <div class="col-lg-11 offset-lg-1">

                <h1 class="jumbotron-heading">Complete waiting list signup of</h1>
                ...
                <p class="lead text-muted">We will contact you when the book at your preffered library becomes available.
                    <br>
                    Please contact us if you have any questions. Happy reading!</p>
                <div class="row">
