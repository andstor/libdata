...
<main role="main">
    <section class="jumbotron text-center m-0">
        <div class="container">
            ...
            } elseif ($status === "waitingsuccess") {
                echo '<div class="alert alert-success" role="alert">Successfully subscribed to waiting list.</div>';
            } elseif ($status === "waitingalready") {
                echo '<div class="alert alert-warning" role="alert">You already subscribed to that book.</div>';
            }
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <form id="librarySelectForm" class="form-group">
            ...
            <h1 class="jumbotron-heading">Loan a book!</h1>
            <p class="lead text-muted">Here you can loan a book. Just find the book you want to loand and select "loan".
                It couldn't be easier. Normally, all book loans are valid for 3 three weeks.
                Please contact us for an extended loaning period. Good reading!</p>
            <p>
                <a href="active_loans.php" class="btn btn-primary my-2">Active loans</a>
                <a href="loaning_history.php" class="btn btn-secondary my-2">Loaning history</a>
            </p>
        </div>
    </section>
